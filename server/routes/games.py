...
def get_games_base_query() -> Query:
    ...
    Returns:
        Query: SQLAlchemy query object for games with related data
    """
...
def get_game(id: int) -> tuple[Response, int] | Response:
    """
    Get a single game by ID with publisher and category information.
    
    Args:
        id: The game ID to retrieve
        
    Returns:
        Response: JSON response containing the game object or error message
