...
This module defines the Category model for managing game categories.
"""
from . import db
...
class Category(BaseModel):
    """Model representing a game category in the crowd funding platform."""
    ...
    def to_dict(self):
        ...
        Returns:
            dict: Dictionary containing category data suitable for JSON serialization
        """
        return {
            'id': self.id,
            'name': self.name,
