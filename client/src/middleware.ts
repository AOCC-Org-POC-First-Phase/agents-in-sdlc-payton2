/**
 * Astro middleware for the Tailspin Toys Crowd Funding platform.
 * This module provides API request forwarding middleware to proxy requests to the Flask backend.
 */
